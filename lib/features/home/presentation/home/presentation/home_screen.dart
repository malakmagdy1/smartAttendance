                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Hello, Farida",
                              style: TextStyle(
                                  fontSize: 18, fontWeight: FontWeight.bold,color: Palette.appColors.mainColor)),
...
Center(
  child: AnimatedBuilder(
    ...
    builder: (context, child) {
      double scale = 1 + 0.1 * (1 - (2 * (_controller.value - 0.5)).abs());
      ...
      return Transform.scale(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isCheckedIn ? Palette.neutral.color3 : Palette.appColors.mainColor,
            boxShadow: [
              BoxShadow(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center,
                    ...
                    ElevatedButton.icon(
                      style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor:
                            isCheckedIn ? Palette.appColors.mainColor : Palette.neutral.color3,
              ...
              //  mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  ...
                  _buildStatCard(
                      "Delays", "3", "5 Delays Remaining", Palette.appColors.mainColor),
                 SizedBox(width: 100,),
                  _buildStatCard(
                      "Attendance", "3", "4 Days left", Palette.neutral.color9),
                ],
              ),
            ],
          ),
